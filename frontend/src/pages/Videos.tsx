    ...
    <div className="space-y-8">
      <header className="space-y-2 text-center max-w-2xl mx-auto mb-12">
        <motion.div
           ...
           className="inline-flex items-center justify-center p-3 bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 rounded-full mb-4"
        >
        ...
        <motion.h1
          ...
          className="text-4xl md:text-5xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-red-600 to-pink-600"
        >
          News Videos
        </motion.h1>
        <motion.p
      ...
      {loading && (
        <div className="flex flex-col items-center justify-center py-20 gap-4">
          ...
          <p className="text-muted-foreground">Curating top videos...</p>
        </div>
      )}
